...
// const array = [1, 2, 3, 4];
// // ค่าที่เป็นเลขคี่
// console.log(array.filter(el => el%2 === 1));
...
// console.log(array.filter(el => el.length > 6));
...
// ];
// // อายุไม่น้อยกว่า 18 
// console.log(array.filter(el => el.age >= 18));
...
// ];
// // id ไม่เท่ากับ 4
// console.log(array.filter(el => el.id !== 4));
...
// ];
// // เกิดเดือน 6
// console.log(array.filter(el => (el.birth).slice(5, 7) === '06'));